...
init:
    image debris1 = Snow("images/effects/debris1.png", max_particles=20, speed=4000, wind=500, xborder=(0,100), yborder=(50,400), depth=100)
    image debris2 = Snow("images/effects/debris2.png", max_particles=50, speed=2000, wind=3000, xborder=(0,100), yborder=(50,400), depth=1000)