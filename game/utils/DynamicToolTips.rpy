init python:
    ...
    class HoverTooltip(renpy.Displayable):
        ...
        def __init__(self, text_size: int = 36, text_style: str = "default", padding: int = 20, spacing: int = 5, bg: str = "gui/rounded_dt_frame.png", text_xmax: int = 700, img_xmax: int = 150, **kwargs):
...
init python:
    style.ttpStyle = Style(style.default)
    style.ttpStyle.color = "#a4a4a4"
    style.ttpStyle.size = 20
    
define tt = HoverTooltip(text_style = 'ttpStyle')
...
# reference : https://github.com/HyJyncks/DynamicTooltips/blob/main/game/utility/DynamicTooltips.rpy