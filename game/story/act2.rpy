...
label when_you_win:
    ...
    $ lipsync(Carla, 'act2', 'audio_7', "You beat my score...")
    
    $ lipsync(Dad, 'act2', 'audio_8', "Hey, hey.")
    $ lipsync(Dad, 'act2', 'audio_9', "It's alright, it's a game.")
    $ lipsync(Dad, 'act2', 'audio_10', "You can beat my score on your turn Carls.")
    
    $ lipsync(Carla, 'act2', 'audio_11', "It's not just a game, it's my game.")
    $ lipsync(Carla, 'act2', 'audio_12', "You weren't supposed to beat it.")
...
label act21:
    ...
    $ lipsync(Mom, 'act2', 'audio_19', "C-Carla!")
    $ lipsync(Mom, 'act2', 'audio_20', "What the hell is this?")
    
    $ lipsync(Carla, 'act2', 'audio_21', "It's great isn't it?!")
...
label act23:
    ...
    hide Dad
    hide Mom
    $ lipsync(Parents, 'act2', 'audio_42', "Carls!")
    hide Parents with dissolve
    """
...
label act26:
    ...
    hide Dad
    hide Mom
    $ lipsync(Parents, 'act2', 'audio_58', "Carla!")
    $ lipsync(Parents, 'act2', 'audio_59', "Please!")
    hide Parents with dissolve
    """
