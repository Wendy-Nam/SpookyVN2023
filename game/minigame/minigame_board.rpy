...
screen game_rules_minigame1:
    frame:
        ...
        padding (450, 500)
        textbutton "{b}START{/b}" action Return() xpos 50 ypos 10 text_style 'rule_button_text'
    pass
...
screen game_rules_minigame2:
    frame:
        ...
        if order_rules_mingame2 == 0:
            ...
            textbutton "{b}NEXT{/b}" action SetVariable('order_rules_mingame2', order_rules_mingame2+1) xpos 50 ypos 10 text_style 'rule_button_text'
        else:
...
screen game_rules_minigame3:
    frame:
        ...
        if order_rules_mingame3 == 0:
            ...
            textbutton "{b}NEXT{/b}" action SetVariable('order_rules_mingame3', order_rules_mingame3+1) xpos 50 ypos 10 text_style 'rule_button_text'
        
        elif order_rules_mingame3 == 1:
            background im.FactorScale("images/ruleboard/rule_combat2.png", 2.0)
            textbutton "{b}NEXT{/b}" action SetVariable('order_rules_mingame3', order_rules_mingame3+1) xpos 50 ypos 50 text_style 'rule_button_text'
